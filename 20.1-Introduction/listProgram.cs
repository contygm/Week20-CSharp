  ...
  static void Main (string[] args)
  {
    ...
    while(true){
        ...
        if(confirmation == "n"){
            ...
            studentInformation.Add("firstName", firstName);
            studentInformation.Add("middleName", firstName);
            studentInformation.Add("lastName", firstName);
            studentInformation.Add("address", address);
            studentInformation.Add("email", email);
            studentInformation.Add("phoneNumber", phoneNumber);
